...
class CommandeController extends AbstractController
{
                                    ...
                                    EntityManagerInterface $manager): Response
    {
        ...
        if(empty($panier)){
        $this->addFlash("error", "Votre panier est vide, vous ne pouvez pas valider votre commande!");

            return $this->redirectToRoute("app_allProduits");
        }
        $dataPanier =[];
        $total = 0;
        ...
        $this->addFlash("success", "Félicitations! Votre commande a bien été prise en compte");
